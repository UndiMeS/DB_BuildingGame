...
namespace RTS_Cam
{
    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void MovementTab()
        {
            ...
            if (camera.limitMap)
            {
                camera.limitXMin = EditorGUILayout.FloatField("Limit X Min: ", camera.limitXMin);
                camera.limitXMax = EditorGUILayout.FloatField("Limit X Max: ", camera.limitXMax);
                camera.limitYMin = EditorGUILayout.FloatField("Limit Y Min: ", camera.limitYMin);
                camera.limitYMax = EditorGUILayout.FloatField("Limit Y Max: ", camera.limitYMax);
            }
