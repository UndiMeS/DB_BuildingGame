...
{    //Aufgabentext je LvL    
    ...
    public  List<string>[] entitys = {
                 ...
                 /*LvL 4*/ new List<string>{"Forschungsprojekte","bereits","existiert"},
    ...
    private List<string>[] beziehungen = {
                 ...
                 /*LvL 4*/ new List<string>{"organisiert","verbessert"},
